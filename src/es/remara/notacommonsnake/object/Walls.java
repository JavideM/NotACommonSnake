...
public class Walls extends Entity{
	...
	public Walls(int level_id, final ITextureRegion txtWall, final GameSnakeScene scene, Activity activity, final VertexBufferObjectManager vbom){
		...
		levelloader.registerEntityLoader(new EntityLoader<SimpleLevelEntityLoaderData>(TAG_ENTITY)
				{
					public IEntity onLoadEntity(final String pEntityName, final IEntity pParent, final Attributes pAttributes, final SimpleLevelEntityLoaderData pSimpleLevelEntityLoaderData) throws IOException
					{
						...
						final int number = SAXUtils.getIntAttributeOrThrow(pAttributes, TAG_ENTITY_ATTRIBUTE_NUMBER);
						final int direction_x = SAXUtils.getIntAttributeOrThrow(pAttributes, TAG_ENTITY_ATTRIBUTE_DIRECTION_X);
						final int direction_y = SAXUtils.getIntAttributeOrThrow(pAttributes, TAG_ENTITY_ATTRIBUTE_DIRECTION_Y);
