...
public class Foods extends Entity{
	...
	public Foods(Walls walls, ResourcesManager resourcesmanager, VertexBufferObjectManager vbom){
		this.resourcesManager = resourcesmanager;
		this.vbom = vbom;
		this.walls = walls;
	
		specialfood = new SpecialFood(FoodType.getRandom(), walls, resourcesmanager, vbom);
	...
	public boolean is_there_food(Entity here){
		...
		if(specialfood.getX() == here.getX() && specialfood.getY() == here.getY()){
			if(here.getClass().equals(Snake.class))
